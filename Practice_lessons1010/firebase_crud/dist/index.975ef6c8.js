...
},{"firebase/app":"5wGMN","firebase/analytics":"gLMpj","firebase/database":"bpqHw"}],"5wGMN":[function(require,module,exports) {
 ...
 */ const getDefaultsFromEnvVariable = ()=>{
    ...
    const defaultsJsonPath = undefined;
    if (defaultsJsonString) {
        if (defaultsJsonPath) console.warn(`Values were provided for both __FIREBASE_DEFAULTS__ ` + `and __FIREBASE_DEFAULTS_PATH__. __FIREBASE_DEFAULTS_PATH__ ` + `will be ignored.`);
        return JSON.parse(defaultsJsonString);
    }
    if (defaultsJsonPath && true) try {
        // eslint-disable-next-line @typescript-eslint/no-require-imports
        const json = require(defaultsJsonPath);
        return json;
    } catch (e) {
        console.warn(`Unable to read defaults from file provided to ` + `__FIREBASE_DEFAULTS_PATH__: ${defaultsJsonPath}`);
    }
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gLMpj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _analytics = require("@firebase/analytics");
 ...
 */ measurementIdToAppId) {
     ...
     */ async function gtagWrapper(command, idOrNameOrParams, gtagParams) {
        try {
            ...
            else if (command === "consent" /* CONSENT */ ) // If CONFIG, second arg must be measurementId.
 ...
 */ async function attemptFetchDynamicConfigWithRetry(appFields, { throttleEndTimeMillis , backoffCount  }, signal, retryData = defaultRetryData // for testing
    ...
    try {
        ...
        const backoffMillis = Number((_b = error === null || error === void 0 ? void 0 : error.customData) === null || _b === void 0 ? void 0 : _b.httpStatus) === 503 ? (0, _util.calculateBackoffMillis)(backoffCount, retryData.intervalMillis, LONG_RETRY_FACTOR) : (0, _util.calculateBackoffMillis)(backoffCount, retryData.intervalMillis);
 ...
 */ function setDefaultEventParameters(customParams) {
    ...
    if (wrappedGtagFunction) wrappedGtagFunction("set" /* SET */ , customParams);
 ...
 */ function setConsent(consentSettings) {
    // Check if reference to existing gtag function on window object exists
    if (wrappedGtagFunction) wrappedGtagFunction("consent" /* CONSENT */ , "update", consentSettings);
 ...
 */ function registerAnalytics() {
    ...
    (0, _app._registerComponent)(new (0, _component.Component)("analytics-internal", internalFactory, "PRIVATE" /* PRIVATE */ ));
...
/** Returns true if error is a FirebaseError that is based on an error from the server. */ function isServerError(error) {
    return error instanceof (0, _util.FirebaseError) && error.code.includes("request-failed" /* REQUEST_FAILED */ );
}
/**
 * @license
 * Copyright 2019 Google LLC
...
async function fetchAuthTokenFromServer(installations, installationEntry) {
    try {
        ...
        await remove(installations.appConfig);
            ...
            const updatedInstallationEntry1 = Object.assign(Object.assign({}, installationEntry), {
                authToken: {
                    requestStatus: 0 /* NOT_STARTED */ 
                }
            });
            await set(installations.appConfig, updatedInstallationEntry1);
        }
        throw e;
    }
}
...
function registerInstallations() {
    (0, _app._registerComponent)(new (0, _component.Component)(INSTALLATIONS_NAME, publicFactory, "PUBLIC" /* PUBLIC */ ));
    (0, _app._registerComponent)(new (0, _component.Component)(INSTALLATIONS_NAME_INTERNAL, internalFactory, "PRIVATE" /* PRIVATE */ ));
}
/**
...
},{"@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","idb":"kozAz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bpqHw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _database = require("@firebase/database");
 ...
 */ function getDatabase(app = (0, _app.getApp)(), url) {
    ...
    const databaseEmulatorHost = (0, _util.getDefaultEmulatorHost)("database");
...
},{"@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","process":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequired883")
